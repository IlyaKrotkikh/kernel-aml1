...
extern int ge2d_open(struct inode *inode, struct file *file);
extern int ge2d_ioctl(struct inode *inode, struct file *filp, unsigned int cmd, unsigned long args);
extern int ge2d_release(struct inode *inode, struct file *file);
