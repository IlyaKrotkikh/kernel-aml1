...
//    {KEY_VOLUMEUP,          	"vol+", CHAN_4, 305, 60},  //0.98v
    {KEY_MENU,          		"menu", CHAN_4, 398, 60},  //1.286v
...
static struct adc_key adc_vol_kp_key[] = {
    {KEY_VOLUMEDOWN,          "vol-", CHAN_4, 0, 60},
    {KEY_VOLUMEUP,            "vol+", CHAN_4, 305, 60},
...
static struct adc_simdetect_platform_data adc_simdetect_pdata = {
    #ifdef CONFIG_AMLOGIC_MODEM
...
static struct platform_device adc_simdetect_device = {
    .name = "m1-adc-simdetect",
    .id = 0,
    .num_resources = 0,
    .resource = NULL,
    .dev = {
    .platform_data = &adc_simdetect_pdata,
    }
};
#endif
...
static struct cap_key it7230_keys[] = {    
    { KEY_HOME,         0x0008, "home"},
    { KEY_MENU,     0x0001, "menu"},
    { KEY_BACK,          0x0002, "exit"},
    { KEY_COMPOSE,         0x0004, "zoom"},
...
void extern_it7230_power(int is_power)
{//extern io OD1
    if(1 == is_power){
        configIO(0, 0);
        setIO_level(0,0, 1);        
...
#define GPIO_ITK_RST ((GPIOD_bank_bit2_24(23)<<16) |GPIOD_bit_bit2_24(23)) 
...
{
		//bt656in_pinmux_init();
	//SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,(1<<13));
    udelay(1000);
...
static int gt2005_v4l2_uninit(void)
{
    ...
    #endif
		CLEAR_CBUS_REG_MASK(HHI_ETH_CLK_CNTL,0x30f);// 24M XTAL
    CLEAR_CBUS_REG_MASK(HHI_DEMOD_PLL_CNTL,0x232);// 24M XTAL
...
static int gc0308_v4l2_uninit(void)
{
	//od2
	 ...
	 configIO(0, 0);
	 setIO_level(0, 1, 2);//30m PWR_Down
 #endif
 /*
    msleep(300);
    set_gpio_val(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), 0);
    set_gpio_mode(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), GPIO_OUTPUT_MODE);   */
    CLEAR_CBUS_REG_MASK(HHI_ETH_CLK_CNTL,0x31e);// 24M XTAL
    CLEAR_CBUS_REG_MASK(HHI_DEMOD_PLL_CNTL,0x232);// 24M XTAL
...
static struct aml_i2c_platform aml_i2c_plat = {
    ...
    .master_i2c_speed2 = AML_I2C_SPPED_100K,
...
static void Set_Lcd_Off(void)
{
}

static void Set_Lcd_On(void)
{
}
...
static struct bq27x00_battery_pdata bq27x00_pdata = {
	...
	.set_charge = set_charge,
	.set_bat_off = set_bat_off,
	.set_lcd_on = Set_Lcd_On,
	.set_lcd_off=Set_Lcd_Off,
    .chip = 1,
};
#endif
