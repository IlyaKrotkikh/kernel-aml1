...
static struct adc_key adc_kp_key[] = {
    ...
    {KEY_UP,  "up", CHAN_4, 179, 60},
    {KEY_DOWN, "down", CHAN_4, 285, 60},
    {KEY_LEFT ,"left", CHAN_4, 400, 60},
    {KEY_RIGHT, "right", CHAN_4, 507, 60},
    {KEY_ESC, "exit", CHAN_4, 623, 60},
    {KEY_ENTER, "ok", CHAN_4, 851, 60},
};
