...
/// Muxing contorl
#define CARD_PIN_MUX_1					0x202D

/// Muxing contorl
#define CARD_PIN_MUX_2					0x202E

/// Muxing contorl
#define CARD_PIN_MUX_3					0x202F
...
#define EGPIO_GPIOB_OUTPUT			CBUS_REG_ADDR(PREG_EGPIO_O)
#define EGPIO_GPIOB_INPUT			CBUS_REG_ADDR(PREG_EGPIO_I)

#define EGPIO_GPIOC_ENABLE			CBUS_REG_ADDR(PREG_FGPIO_EN_N)
#define EGPIO_GPIOC_OUTPUT			CBUS_REG_ADDR(PREG_FGPIO_O)
...
#define EGPIO_GPIOE_OUTPUT			CBUS_REG_ADDR(PREG_HGPIO_EN_N)
#define EGPIO_GPIOE_INPUT			CBUS_REG_ADDR(PREG_HGPIO_I)
