...
/* For compat with original DIGMA IDX7 T1-T4 firmware (SYSTEM DATA MUST BE 256Mb instead 512 by SDK)

#define SET_256M_SYSTEM
...
static struct cap_key it7230_keys[] = {
    ...
    { KEY_BACK,     0x0004, "exit"},
    { KEY_MENU,     0x0002, "menu"},
...
#ifdef SET_256M_SYSTEM /* old style original parts */
...
#define BL_MAX_LEVEL 1200 //60000
...
static void __init LED_PWM_REG0_init(void)
{
    ...
    WRITE_CBUS_REG_BITS(LED_PWM_REG0,0,0,4); //adust cpu1.2v   to 1.26V
