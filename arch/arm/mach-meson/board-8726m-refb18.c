...
static int adc_kp_led_control(int *param)
{
    if(param[0] == 0){//led off
    	...
    	if ((param[1]!=KEY_VOLUMEUP) && (param[1]!=KEY_VOLUMEDOWN)){
...
static struct adc_key adc_kp_key[] = {
    ...
    {KEY_BACK,            "exit",     CHAN_4, 509, 60},
    {KEY_MENU,            "menu",     CHAN_4, 633, 60},
...
#define UOR6X5X_XLCD    1024
#define UOR6X5X_YLCD    600
#define UOR6X5X_SWAP_XY 1
#define UOR6X5X_XPOL    1
...
static void ic_control(int flag)//CHG_ENABLE
{
    if(flag) {//ic on
...
static struct android_usb_platform_data android_usb_pdata = {
       ...
       .product_id     = 0x0c01,
       .version        = 0x0100,
       .product_name   = "Outform",
       .manufacturer_name = "Outform",
