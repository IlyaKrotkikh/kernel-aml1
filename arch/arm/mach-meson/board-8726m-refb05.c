...
static void bt_device_init(void)
{
	...
	//BT/GPS -GPIOC_7
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_2, (1<<25));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<17));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<12));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<6));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<7));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<7));
	...
	//BT_WAKE -GPIOD_5
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<10));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<5));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<22));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<22));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_8, (1<<3));
	...
	/* BG/GPS low */
	CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<7));
	CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<7));	
	
	/* UART RTS */
	CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<22));
