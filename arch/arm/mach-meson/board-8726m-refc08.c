...
{
#if 1
    /* BT/GPS_RST_N ----GPIOC_8*/    
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_2, (1<<24));
    ...
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<5));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<8));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<8));
    ...
    /* BT_WAKE---GPIOC15 */
		...
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<0));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<14));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<4));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<15));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<15));
	
		/* UART_RTS_N(BT) ---GPIOC22*/
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<10));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<3));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<6));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<7));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<8));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<2));

    /* UART_CTS_N(BT) ---GPIOC21*/    
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<10));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<3));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<9));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<10));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<11));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<3));
    
		/* WLBT_REGON --GPIOA_3*/
    CLEAR_CBUS_REG_MASK(PREG_EGPIO_EN_N, (1<<3));
    SET_CBUS_REG_MASK(PREG_EGPIO_O, (1<<3));	    
	
		/* BT/GPS_RST_N --GPIOC8*/
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<8));
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<8));	
		msleep(200);
		SET_CBUS_REG_MASK(PREG_FGPIO_O,(1<<8));

    /* UART_RTS_N(BT) ----GPIOC22*/
    SET_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<22));    
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<22));

		/* UART_CTS_N(BT) GPIOC21*/
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<21));
    CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<21));

		/***uart_tx----gpioc9*/
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<9));
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<9));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<17));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<12));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<4));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<9));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<9));		
		SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,(1<<24));
		/********uart_rx-----gpioc10****/
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_EN_N, (1<<10));
		CLEAR_CBUS_REG_MASK(PREG_FGPIO_O, (1<<10));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<17));
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<12));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<3));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<10));	
		CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<10));		
		SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,(1<<23));
#endif
}
...
static int rt5621_mute_func(int flag)
{
...
static void __init mute_pwrcon_pinmux_init(void)
{
    /*Set GPIOC_19 as PWR_CON*/
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, ((1<<0)|(1<<10)));
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<4));
    
    /*Set GPIOC_3 as MUTE*/
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, ((1<<10)|(1<<13)|(1<<19)));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<3));
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<3));	
}

static void __init spdif_pinmux_init(void)
{
	/*SPDIF OUTPUT*/
	printk(KERN_INFO "spdif_pinmux_init!! \n");
	...
	SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_0, (1<<19));
	printk("READ_CBUS_REG(0)=0x%08x !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n", READ_CBUS_REG(PERIPHS_PIN_MUX_0));
}
...
static void __init eth_pinmux_init(void)
{
	...
	set_gpio_val(GPIOC_bank_bit0_26(26),GPIOC_bit_bit0_26(26),0);
...
{
	printk(KERN_INFO "enter disable_unused_model!\n");
...
static void __init set_power_control(int flag)
{
	if(flag)
...
static void __init set_mute_power_control(void)
{
    printk(KERN_INFO "set_power_control!\n");
    set_power_control(0);
    msleep(50);
#ifdef CONFIG_SND_SOC_RT5621
	rt5621_mute_func(1);
