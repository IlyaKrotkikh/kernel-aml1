...
struct codec_profile_t *vcodec_profile[SUPPORT_VDEC_NUM] = {0};
static int vcodec_profile_idx = 0;

ssize_t vcodec_profile_read(char *buf,int size)
{
	char *pbuf = buf;
	int i = 0;
...
int vcodec_profile_register(struct codec_profile_t *vdec_profile)
{
