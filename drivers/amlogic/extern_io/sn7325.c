...
static ssize_t write_sn7325(struct device *dev, struct device_attribute *attr, char *buf, size_t count);
static DEVICE_ATTR(write, S_IRWXUGO, 0, (void*)write_sn7325);
