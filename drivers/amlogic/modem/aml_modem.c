...
static int modem_set_block(void *data, bool blocked)
{
    ...
    pData = (struct aml_modem_pdata *)data;
...
static struct platform_driver aml_modem_driver = {
    .driver = {
        .name = "aml-modem",
        .owner = THIS_MODULE,	
    },
...
static int __init aml_modem_init(void)
{
	...
	return platform_driver_register(&aml_modem_driver);
}

static void __exit aml_modem_exit(void)
{
	platform_driver_unregister(&aml_modem_driver);
}
