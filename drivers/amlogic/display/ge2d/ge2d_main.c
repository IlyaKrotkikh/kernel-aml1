...
int ge2d_open(struct inode *inode, struct file *file) 
{
...
int ge2d_ioctl(struct inode *inode, struct file *filp,
...
int ge2d_release(struct inode *inode, struct file *file)
{
