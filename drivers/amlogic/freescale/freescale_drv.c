...
int get_freescale_bypass_mode(void)
{
    return freescale_device.bypass;
}

int get_freescale_property_change(void)
{
    return property_change;	
}
void set_freescale_property_change(int flag)
{
...
int  init_freescale_device(void)
{
    ...
    freescale_device.angle=0;
    freescale_device.videoangle=0;
