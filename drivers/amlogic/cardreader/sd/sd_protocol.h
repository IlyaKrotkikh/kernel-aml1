...
#define SD_MMC_IDENTIFY_TIMEOUT			2000	// ms, SD=1000, MMC=500
#define MAX_CHECK_INSERT_RETRY          5
    
#define SD_IDENTIFICATION_TIMEOUT       (500*TIMER_1MS)	// ms
#define SD_PROGRAMMING_TIMEOUT          (2000*TIMER_1MS)	// ms
    
#define SDIO_FUNCTION_TIMEOUT			1000
    
#define SD_MMC_INIT_RETRY				5
